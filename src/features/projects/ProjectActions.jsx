...
function ProjectActions({ leftSidebarExpanded }) {
  return (
    <div
      className={`w-full py-10 px-8 flex flex-col gap-6 border-b border-border ${!leftSidebarExpanded && "items-center"} max-phone-lg:px-16 max-phone-lg:py-12 max-phone-lg:gap-10 max-phone-sm:px-8 max-phone-sm:gap-12`}>
      <ButtonIcon
        icon={
          <AddLarge
            size={20}
