...
function RightSidebar() {
  const { openProjectId, currentMobileSidebar, isMobileLayout } = useSelector(
    (state) => state.ui
  );
  ...
  return (
    <>
      ...
      <aside
        ...
        inert={isMobileLayout && currentMobileSidebar !== "right"}
        aria-hidden={isMobileLayout && currentMobileSidebar !== "right"}>
